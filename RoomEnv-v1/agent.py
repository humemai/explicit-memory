...
from explicit_memory.utils import ReplayBuffer, write_yaml, is_running_notebook
from nn import LSTM
    ...
    def fill_replay_buffer(self) -> None:
        ...
        while len(self.replay_buffer) < self.batch_size:
            ...
            while not done and len(self.replay_buffer) < self.batch_size:
                # print(
                #     self.replay_buffer.obs_buf,
                #     self.replay_buffer.next_obs_buf,
                #     self.replay_buffer.acts_buf,
                #     self.replay_buffer.rews_buf,
                #     self.replay_buffer.done_buf,
